...
std_matrix_train= train_data[feature]
std_matrix_test= test_data[feature]
...
df.to_csv("svr_pred_list2.csv", encoding='utf-8', index=False)
...
df = pd.DataFrame.from_items(df)
df.to_csv("gbrt_pred_list2.csv", encoding='utf-8', index=False)
#gbrt_score=gbrt_model.score(std_matrix_test,std_Y_test)
#print(gbrt_score)
